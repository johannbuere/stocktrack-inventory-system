...
public class Menu extends javax.swing.JPanel {
    ...
    private void init() {
        ...
        listMenu1.addItem(new Menu_Model("3", "Receptionist", Menu_Model.MenuType.MENU));
        listMenu1.addItem(new Menu_Model("4", "Stocks", Menu_Model.MenuType.MENU));
        listMenu1.addItem(new Menu_Model("5", "Orders", Menu_Model.MenuType.MENU));
        ...
        listMenu1.addItem(new Menu_Model("", " ", Menu_Model.MenuType.EMPTY));
        listMenu1.addItem(new Menu_Model("6", "Account", Menu_Model.MenuType.MENU));
        listMenu1.addItem(new Menu_Model("7", "Logout", Menu_Model.MenuType.MENU));
        listMenu1.addItem(new Menu_Model("", "", Menu_Model.MenuType.EMPTY));
    }
